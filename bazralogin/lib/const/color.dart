...
class ColorsConsts {
  ...
  static Color starterColorconst = const Color(0xFF8E24AA); //purple 600
  static Color purple800 = const Color(0xFF6A1B9A);
  static Color backbazra = const Color(0x53665);
  static Color backbazra1 = const Color(0xFAFAFA);
  static Color backbazra2 = const Color(0xCCE8FF);
}
